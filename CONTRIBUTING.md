...
完整交付還需要在乾淨、隔離的 Sites／Vinext scaffold 安裝範本，跑 `npm run lint`、`npm test`、`npm run build`，並用瀏覽器實測 1440×1000、1024×900、390×844 的實際成品。若無法完成 runtime 或人眼檢查，請明確標示「已製作但未驗證」。
